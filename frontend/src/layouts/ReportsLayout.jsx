...
const ReportsLayout = () => {
    ...
    const reportLinks = [
        ...
        { path: '/reports/trainers', label: safeT('reports.trainersReport', isRTL ? 'ØªÙ‚Ø±ÙŠØ± Ø§Ù„Ù…Ø¯Ø±Ø¨ÙŠÙ†' : 'Trainer Report'), icon: Wallet },
        ...
        { path: '/reports/gym-income-sessions', label: safeT('reports.gymIncomeSessions', isRTL ? 'Ø¯Ø®Ù„ Ø§Ù„Ø¬ÙŠÙ… - Ø§Ù„Ø¬Ù„Ø³Ø§Øª' : 'Gym Income - Sessions'), icon: Banknote },
